...
let questions = [
    {
        text: 'Аварийные утечки на линейных задвижках ликвидируются:',
        right: 1,
        answers: ['заменой паронитовой прокладки', 'донабивкой сальниковых уплотнений', 'демонтажом фланцевых соединений',],
    },
];
