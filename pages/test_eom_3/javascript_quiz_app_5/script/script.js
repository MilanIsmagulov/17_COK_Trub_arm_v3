// dran&drop 2
const anwserArr2 = ['клин', 'маховик',  'кожух',  'шибер', 'шар', 'ключ-рукоятка', 'прокладка', 'уплотнение сальниковое', 'стойка']; //Ответы
const countCol = 3; //Колличесвто колонн
const correctAnwser1 = ['клин', 'маховик' ] //Правильные варианты. Кол-во масивов в соотвествиие с кол-ом колонн
const correctAnwser2 = ['шибер', 'кожух', 'стойка'] //correctAnwser1 - 1 колонна и т.д.
const correctAnwser3 = ['шар', 'уплотнение сальниковое', 'ключ-рукоятка']
...
function init2() {
    createColumns();
    localStorage.getItem('data5') ? loadList2() : createList2()
}
...
let questionText = 'Установите соответствие между основными узлами и наименованием трубопроводной арматуры';
...
function createColumns() {
    ...
    columnHeader.innerHTML = 'Задвижка клиновая'
    columnHeader2.innerHTML = 'Задвижка шиберная'
    columnHeader3.innerHTML = 'Кран шаровой'
