...
let questions = [
    {
        text: 'При замене прокладки во фланцевом соединении задвижки ослабить крепёж фланцевого соединения, начиная:',
        right: 1,
        answers: ['с нижней и верхней шпильки одновременно', 'с нижней шпильки и с противоположной стороны от работающего', 'с верхней шпильки',],
    },
];
