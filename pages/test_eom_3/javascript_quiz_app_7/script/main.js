...
let mainQuestions = [
    {
        text: 'Укажите функции запорной арматуры. Выберете все правильные варианты.',
        right: [0,4,2],
        type: 3,
        points: 100,
        answers: ['полное перекрытие потока рабочей среды', 'не изменяемость потока расхода, давления и скорости ', 'дросселирование потока среды', 'регулирование потока среды', 'переключение потока или его части из одной ветви системы в другую'],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn1.setAttribute('onclick', "location.href='../javascript_quiz_app_6/index.html'")
    ...
    nextBtn.setAttribute('onclick', "location.href='../javascript_quiz_app_8/index.html'")
