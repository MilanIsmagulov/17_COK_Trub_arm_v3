...
let mainQuestions = [
    {
        ...
        type: 3,
        points: 100,
        answers: ['полное перекрытие потока рабочей среды', 'неизменяемость потока расхода, давления и скорости ', 'дросселирование потока среды', 'регулирование потока среды', 'переключение потока или его части из одной ветви системы в другую'],
    },
];
