...
let mainQuestions = [
    {
        text: 'Укажите требования к запорной арматуре. Выберете все правильные варианты.',
        right: [0,1,2],
        type: 3,
        points: 100,
        answers: ['минимальное гидравлическое сопротивление полностью открытой арматуры', 'легкость срабатывания после длительной эксплуатации в открытом положении', 'герметичность затвора и всех уплотнений', 'максимальное гидравлическое сопротивление полностью открытой арматуры', 'наличие возможности утечек через сальниковые уплотнения'],
    },
];
