...
let questions = [
    {
        text: 'Для защиты трубопроводов и нефтегазопромыслового оборудования от механического разрушения от избыточного давления предназначен',
        right: 0,
        answers: ['предохранительный клапан', 'предохранительный вентиль', 'регулирующий клапан', 'дисковый затвор',],
    },
];
