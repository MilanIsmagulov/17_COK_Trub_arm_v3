...
let questions = [
    {
        text: 'Какими двумя основными параметрами характеризуется трубопроводная арматура ',
        right: 2,
        answers: ['номинальная температура и номинальная толщина стенки', 'условная температура и условная высота', 'условный проход и условное давление',],
    },
];
